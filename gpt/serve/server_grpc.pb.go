...
type TestGrpcClient interface {
	TestRpc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *testGrpcClient) TestRpc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/TestGrpc/TestRpc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestGrpcServer interface {
	TestRpc(context.Context, *Request) (*Response, error)
...
func (UnimplementedTestGrpcServer) TestRpc(context.Context, *Request) (*Response, error) {
...
func _TestGrpc_TestRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestGrpcServer).TestRpc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TestGrpc/TestRpc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestGrpcServer).TestRpc(ctx, req.(*Request))
	}
...
var TestGrpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TestRpc",
			Handler:    _TestGrpc_TestRpc_Handler,
		},
	},
