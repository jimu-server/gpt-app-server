...
func (receiver *AppChatConversationItem) TableName() string {
...
func (receiver *AppChatMessage) TableName() string {
...
func (receiver *AppChatKnowledgeFile) TableName() string {
...
func (receiver *AppChatKnowledgeInstance) TableName() string {
...
func (receiver *AppChatPlugin) TableName() string {
